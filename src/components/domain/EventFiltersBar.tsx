...
export function EventFiltersBar({ filters, onChange, onReset }: EventFiltersBarProps) {
    ...
    <Card className="border-0 shadow-none">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-bold text-[var(--color-fg)]">Filters</h3>
        ...
        <div className={cn("transition-transform duration-200", isCollapsed ? "" : "rotate-180")}>
          <svg viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5 opacity-40">
        ...
        <CardBody className="space-y-4 border-t border-[var(--color-border)]/20 px-5 pb-6 pt-5">
          <div>
            ...
            <Select
              ...
              onChange={(e) => set("source", (e.target.value || undefined) as EventFilters["source"])}
            >
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={(v) => set("min_magnitude", v === 0 ? undefined : v)}
